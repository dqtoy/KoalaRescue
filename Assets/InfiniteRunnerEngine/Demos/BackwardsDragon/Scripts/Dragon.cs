...
namespace MoreMountains.InfiniteRunnerEngine
{
	...
	public class Dragon : Flappy
	{
	    ...
	    protected override void UpdateAllMecanimAnimators()
	    {
			...
			MMAnimator.UpdateAnimatorBoolIfExists(_flameAnimator, "Jumping", _jumping);
	    }
	    ...
	    protected override void Update()
	    {
	        ...
	        if (_grounded)
	        {
				...
				MMAnimator.UpdateAnimatorBoolIfExists(explosion.GetComponent<Animator>(), "Grounded", _grounded);
