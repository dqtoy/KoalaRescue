...
namespace MoreMountains.InfiniteRunnerEngine
{
    public class HillRider : Jumper
    {
        ...
        protected override void Initialize()
        {
            ...
            ModelContainer.gameObject.GetComponentNoAlloc<MMFollowTarget>().Target = this.transform;
            ModelContainer.gameObject.GetComponentNoAlloc<MMFollowTarget>().Offset += Vector3.up * -_circleCollider.radius * this.transform.localScale.y;
            
            if (Camera.main.gameObject.GetComponentNoAlloc<CameraBehavior>() != null)
            {
                Camera.main.gameObject.GetComponentNoAlloc<CameraBehavior>().TargetOverride = this.transform;
            }            
